...
async def handle_media_stream(websocket: WebSocket):
    ...
    try:
        ...
        print(">>> WebSocket accepté avec succès")
    except Exception as e:
        print(f">>> Erreur acceptation WebSocket: {e}")
        return
    ...
    try:
        async with websockets.connect(
            ...
            print(">>> Connecté à OpenAI Realtime")
            ...
            async def receive_from_twilio():
                ...
                try:
                    ...
                    print(f"Erreur receive_from_twilio: {e}")

            async def send_to_twilio():
                nonlocal stream_sid, call_sid, last_assistant_item, response_start_timestamp_twilio, session_ready
                try:
...
async def send_initial_conversation_item(openai_ws):
    ...
    initial_item = {
        ...
        "item": {
            ...
            "content": [{
                "type": "input_text",
                "text": "Présente-toi brièvement en tant qu’assistant de gestion locative et demande comment tu peux aider le locataire aujourd’hui."
            }]
        }
    }
